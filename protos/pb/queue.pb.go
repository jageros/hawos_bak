...
func init() {
	proto.RegisterType((*QueueMsg)(nil), "pb.QueueMsg")
...
var fileDescriptor_96e4d7d76a734cd8 = []byte{
	...
	,
}
...
func (m *QueueMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintQueue(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Target) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UnlessUids) > 0 {
		for iNdEx := len(m.UnlessUids) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintQueue(dAtA, i, uint64(len(m.UnlessUids[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.Uids) > 0 {
		for iNdEx := len(m.Uids) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintQueue(dAtA, i, uint64(len(m.Uids[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.GroupId) > 0 {
		...
		i = encodeVarintQueue(dAtA, i, uint64(len(m.GroupId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
